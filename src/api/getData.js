...
export const login = data => fetch('/shiro/appLogin', data, 'GET','fetch',{},'authen');
...
export const addUser = data => fetch('/sysbackuser/save', data, 'POST','fetch',{});
 ...
 * 获取用户列表
 */
export const getUserList = data => fetch('/sysbackuser/search', data);
...
export const getbaidu=url=>fetch(url);
